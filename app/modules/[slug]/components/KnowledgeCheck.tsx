                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3 flex-1">
                    <div className={cn(
                      ...
                      !showResult && !isSelected && (isDarkMode ? "border-white/20" : "border-gray-300"),
        ...
        <div className="flex justify-end">
          {!showResult ? (
            ...
            <button
              ...
              className="px-6 py-2.5 rounded-lg font-medium text-sm bg-blue-600 hover:bg-blue-700 text-white transition-all flex items-center gap-2"
            >
              Continue
              <ArrowRight size={16} />
            </button>
